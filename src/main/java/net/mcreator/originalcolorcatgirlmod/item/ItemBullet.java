...
public class ItemBullet extends ElementsOriginalColorCatgirlMod.ModElement {
	@GameRegistry.ObjectHolder("originalcolorcatgirlmod:bullet")
	public static final Item block = null;
	public ItemBullet(ElementsOriginalColorCatgirlMod instance) {
		super(instance, 6);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("originalcolorcatgirlmod:bullet", "inventory"));
	}
