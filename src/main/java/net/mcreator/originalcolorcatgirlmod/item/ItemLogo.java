...
public class ItemLogo extends ElementsOriginalColorCatgirlMod.ModElement {
	@GameRegistry.ObjectHolder("originalcolorcatgirlmod:logo")
	public static final Item block = null;
	public ItemLogo(ElementsOriginalColorCatgirlMod instance) {
		super(instance, 4);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("originalcolorcatgirlmod:logo", "inventory"));
	}
